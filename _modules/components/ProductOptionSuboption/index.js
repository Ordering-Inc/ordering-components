...
var ProductOptionSuboption = function ProductOptionSuboption(props) {
  ...
  if (selected && props.state.quantity && props.state.quantity > 0) {
    ...
    var _option$name;
    quantity = (option === null || option === void 0 ? void 0 : (_option$name = option.name) === null || _option$name === void 0 ? void 0 : _option$name.toLowerCase()) === 'queso y salsa' && isAlsea ? props.state.quantity : 1;
  }
