...
var PlaceSpot = function PlaceSpot(props) {
  ...
  var handleChangeSpot = /*#__PURE__*/function () {
        ...
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _bodyToSend = _objectSpread(_objectSpread({}, bodyToSend), {}, {
              user_id: isCustomerMode ? customerState === null || customerState === void 0 ? void 0 : (_customerState$user = customerState.user) === null || _customerState$user === void 0 ? void 0 : _customerState$user.id : user === null || user === void 0 ? void 0 : user.id
            });
    ...
    return function handleChangeSpot(_x2) {
