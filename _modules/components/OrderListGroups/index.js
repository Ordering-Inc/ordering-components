...
var OrderListGroups = function OrderListGroups(props) {
  var _props$combineTabs, _configs$combine_pend, _configs$logistic_mod, _configs$notification, _configs$notification2, _orderGroupStatusCust, _orderGroupStatusCust2, _orderGroupStatusCust3, _orderGroupStatusCust4, _orderGroupStatusCust5, _paginationSettings$p, _paginationSettings$p2, _ordersGroup$currentT18;
  ...
  var _combineTabs = (_props$combineTabs = props.combineTabs) !== null && _props$combineTabs !== void 0 ? _props$combineTabs : (configs === null || configs === void 0 ? void 0 : (_configs$combine_pend = configs.combine_pending_and_progress_orders) === null || _configs$combine_pend === void 0 ? void 0 : _configs$combine_pend.value) === '1';
  ...
  var notificationStatusses = props.isDriverApp ? (configs === null || configs === void 0 ? void 0 : (_configs$notification = configs.notification_driver_states) === null || _configs$notification === void 0 ? void 0 : _configs$notification.value.split('|').map(function (value) {
    return Number(value);
  })) || [] : (configs === null || configs === void 0 ? void 0 : (_configs$notification2 = configs.notification_business_states) === null || _configs$notification2 === void 0 ? void 0 : _configs$notification2.value.split('|').map(function (value) {
    return Number(value);
  })) || [];
        ...
        while (1) switch (_context3.prev = _context3.next) {
          ...
          case 4:
            ...
            return getOrders({
              page: 1,
              pageSize: pageSize,
              orderStatus: options !== null && options !== void 0 && options.allStatusses ? null : (_ordersGroup$currentT6 = ordersGroup[currentTabSelected]) === null || _ordersGroup$currentT6 === void 0 ? void 0 : _ordersGroup$currentT6.currentFilter,
  ...
  var loadMoreOrders = /*#__PURE__*/function () {
    var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
      var options,
        ...
        _ordersGroup$currentT10,
        _ordersGroup$currentT11,
        _ordersGroup$currentT12,
        _yield$getOrders2,
        ...
        while (1) switch (_context4.prev = _context4.next) {
          case 0:
            ...
            return getOrders({
              ...
              orderStatus: options !== null && options !== void 0 && options.allStatusses ? null : (_ordersGroup$currentT9 = ordersGroup[currentTabSelected]) === null || _ordersGroup$currentT9 === void 0 ? void 0 : _ordersGroup$currentT9.currentFilter,
              newFetch: true
            });
          case 5:
  ...
  var deleteOrders = /*#__PURE__*/function () {
    var _ref8 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(orderIds) {
      var _ordersGroup$currentT13, _ordersGroup$currentT14, _ordersGroup$currentT15, errorState, _yield$ordering$setAc3, error, _iterator, _step, id, _yield$ordering$setAc4, multiError, isError, idsDeleted, _err$message4;
      ...
      return _regeneratorRuntime().wrap(function _callee10$(_context10) {
        while (1) switch (_context10.prev = _context10.next) {
          ...
          case 11:
            ...
            return _context10.abrupt("return", (_err$message5 = _context10.t0 === null || _context10.t0 === void 0 ? void 0 : _context10.t0.message) !== null && _err$message5 !== void 0 ? _err$message5 : _context10.t0);
          case 14:
          case "end":
      ...
      return _regeneratorRuntime().wrap(function _callee12$(_context12) {
        while (1) switch (_context12.prev = _context12.next) {
          ...
          case 11:
            ...
            return _context12.abrupt("return", (_err$message6 = _context12.t0 === null || _context12.t0 === void 0 ? void 0 : _context12.t0.message) !== null && _err$message6 !== void 0 ? _err$message6 : _context12.t0);
          case 14:
          case "end":
        ...
        while (1) switch (_context13.prev = _context13.next) {
          ...
          case 11:
            ...
            if (_context13.t0.constructor.name !== 'Cancel') {
              setOrdersGroup(_objectSpread(_objectSpread({}, ordersGroup), {}, _defineProperty({}, currentTabSelected, _objectSpread(_objectSpread({}, ordersGroup[currentTabSelected]), {}, {
                loading: false,
                error: [(_err$message7 = _context13.t0 === null || _context13.t0 === void 0 ? void 0 : _context13.t0.message) !== null && _err$message7 !== void 0 ? _err$message7 : 'ERROR']
              }))));
            }
          case 14:
          case "end":
  ...
  (0, _react.useEffect)(function () {
    ...
    } else if (!((_ordersGroup$currentT17 = ordersGroup[currentTabSelected]) !== null && _ordersGroup$currentT17 !== void 0 && _ordersGroup$currentT17.fetched) && props.isNetConnected) {
      loadOrders({
  ...
  (0, _react.useEffect)(function () {
    var _session$user7, _session$user8, _socket$socket, _socket$socket$_callb, _socket$socket2, _socket$socket2$_call, _socket$socket2$_call2, _socket$socket3, _socket$socket3$_call, _socket$socket4, _socket$socket4$_call, _socket$socket4$_call2, _socket$socket5, _socket$socket5$_call, _socket$socket6, _socket$socket6$_call, _socket$socket6$_call2, _socket$socket7, _socket$socket7$_call, _socket$socket8, _socket$socket8$_call, _socket$socket8$_call2;
    if (!(socket !== null && socket !== void 0 && socket.socket)) return;
    var handleUpdateOrder = function handleUpdateOrder(order) {
      var _order$products, _session$user5, _orderFound, _orderFound$driver, _order$driver, _session$user6;
      var isGiftCard = order === null || order === void 0 ? void 0 : (_order$products = order.products) === null || _order$products === void 0 ? void 0 : _order$products.some(function (product) {
    ...
    var handleAddNewOrder = function handleAddNewOrder(order) {
      ...
      var isGiftCard = order === null || order === void 0 ? void 0 : (_order$products2 = order.products) === null || _order$products2 === void 0 ? void 0 : _order$products2.some(function (product) {
        return (product === null || product === void 0 ? void 0 : product.type) === 'gift_card';
      });
      if (isGiftCard && !isDriverApp) return;
    ...
    if (!(socket !== null && socket !== void 0 && (_socket$socket3 = socket.socket) !== null && _socket$socket3 !== void 0 && (_socket$socket3$_call = _socket$socket3._callbacks) !== null && _socket$socket3$_call !== void 0 && _socket$socket3$_call.$order_assigned) || socket !== null && socket !== void 0 && (_socket$socket4 = socket.socket) !== null && _socket$socket4 !== void 0 && (_socket$socket4$_call = _socket$socket4._callbacks) !== null && _socket$socket4$_call !== void 0 && (_socket$socket4$_call2 = _socket$socket4$_call.$order_assigned) !== null && _socket$socket4$_call2 !== void 0 && _socket$socket4$_call2.find(function (func) {
      return (func === null || func === void 0 ? void 0 : func.name) !== 'handleAddNewOrder';
    })) {
      socket.on('order_assigned', handleAddNewOrder);
    }
    if (!(socket !== null && socket !== void 0 && (_socket$socket5 = socket.socket) !== null && _socket$socket5 !== void 0 && (_socket$socket5$_call = _socket$socket5._callbacks) !== null && _socket$socket5$_call !== void 0 && _socket$socket5$_call.$update_order) || socket !== null && socket !== void 0 && (_socket$socket6 = socket.socket) !== null && _socket$socket6 !== void 0 && (_socket$socket6$_call = _socket$socket6._callbacks) !== null && _socket$socket6$_call !== void 0 && (_socket$socket6$_call2 = _socket$socket6$_call.$update_order) !== null && _socket$socket6$_call2 !== void 0 && _socket$socket6$_call2.find(function (func) {
      return (func === null || func === void 0 ? void 0 : func.name) !== 'handleUpdateOrder';
    })) {
      socket.on('update_order', handleUpdateOrder);
    }
    if (!(socket !== null && socket !== void 0 && (_socket$socket7 = socket.socket) !== null && _socket$socket7 !== void 0 && (_socket$socket7$_call = _socket$socket7._callbacks) !== null && _socket$socket7$_call !== void 0 && _socket$socket7$_call.$message) || socket !== null && socket !== void 0 && (_socket$socket8 = socket.socket) !== null && _socket$socket8 !== void 0 && (_socket$socket8$_call = _socket$socket8._callbacks) !== null && _socket$socket8$_call !== void 0 && (_socket$socket8$_call2 = _socket$socket8$_call.$message) !== null && _socket$socket8$_call2 !== void 0 && _socket$socket8$_call2.find(function (func) {
  ...
  (0, _react.useEffect)(function () {
    ...
    socket.on('disconnect', function () {
      ...
      socket.join((session === null || session === void 0 ? void 0 : (_session$user13 = session.user) === null || _session$user13 === void 0 ? void 0 : _session$user13.level) === 0 ? 'messages_orders' : "messages_orders_".concat(session === null || session === void 0 ? void 0 : (_session$user14 = session.user) === null || _session$user14 === void 0 ? void 0 : _session$user14.id));
    });
    var ordersRoom = (session === null || session === void 0 ? void 0 : (_session$user15 = session.user) === null || _session$user15 === void 0 ? void 0 : _session$user15.level) === 0 ? 'orders' : "orders_".concat(session === null || session === void 0 ? void 0 : (_session$user16 = session.user) === null || _session$user16 === void 0 ? void 0 : _session$user16.id);
    var messagesOrdersRoom = (session === null || session === void 0 ? void 0 : (_session$user17 = session.user) === null || _session$user17 === void 0 ? void 0 : _session$user17.level) === 0 ? 'messages_orders' : "messages_orders_".concat(session === null || session === void 0 ? void 0 : (_session$user18 = session.user) === null || _session$user18 === void 0 ? void 0 : _session$user18.id);
    var requestsRoom = "requests_".concat(session === null || session === void 0 ? void 0 : (_session$user19 = session.user) === null || _session$user19 === void 0 ? void 0 : _session$user19.id);
    var groupsRoom = "ordergroups_".concat(session === null || session === void 0 ? void 0 : (_session$user20 = session.user) === null || _session$user20 === void 0 ? void 0 : _session$user20.id);
    socket.join(ordersRoom);
    socket.join(requestsRoom);
    socket.join(groupsRoom);
  ...
  (0, _react.useEffect)(function () {
    var handleCustomerReviewed = function handleCustomerReviewed(review) {
      var orderFound = null;
      for (var i = 0; i < ordersStatusArray.length; i++) {
        var _ordersGroup$status4, _ordersGroup$status4$;
        var status = ordersStatusArray[i];
        orderFound = (_ordersGroup$status4 = ordersGroup[status]) === null || _ordersGroup$status4 === void 0 ? void 0 : (_ordersGroup$status4$ = _ordersGroup$status4.orders) === null || _ordersGroup$status4$ === void 0 ? void 0 : _ordersGroup$status4$.find(function (_order) {
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, UIComponent && /*#__PURE__*/_react.default.createElement(UIComponent, _extends({}, props, {
    ...
    ordersFormatted: formatOrdersGrouped((_ordersGroup$currentT18 = ordersGroup[currentTabSelected]) === null || _ordersGroup$currentT18 === void 0 ? void 0 : _ordersGroup$currentT18.orders),
