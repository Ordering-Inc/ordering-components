...
var BusinessController = function BusinessController(props) {
  ...
  var addFavoriteBusiness = /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee2() {
      var _businessState$busine, changes, requestOptions, response, content, _businessState$busine2, _businessState$busine3, updateIds;
          ...
          switch (_context2.prev = _context2.next) {
            ...
            case 12:
              ...
              if (!content.error) {
                ...
                if (favoriteIds) {
                  updateIds = [].concat(_toConsumableArray(favoriteIds), [businessState === null || businessState === void 0 ? void 0 : (_businessState$busine3 = businessState.business) === null || _businessState$busine3 === void 0 ? void 0 : _businessState$busine3.id]);
                  setFavoriteIds(updateIds);
                }

                showToast(_ToastContext.ToastType.Success, t('FAVORITE_ADDED', 'Favorite added'));
              } else {
                setActionState(_objectSpread(_objectSpread({}, actionState), {}, {
                  loading: false,
  ...
  var deleteFavoriteBusiness = /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee3() {
      var _businessState$busine4, response, content, _businessState$busine5, updateIds;
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 2:
              ...
              _context3.next = 7;
              return fetch("".concat(ordering.root, "/users/").concat(user.id, "/favorite_businesses/").concat(businessState === null || businessState === void 0 ? void 0 : (_businessState$busine4 = businessState.business) === null || _businessState$busine4 === void 0 ? void 0 : _businessState$busine4.id), {
                method: 'DELETE',
                headers: {
                  'Content-Type': 'application/json',
                  Authorization: "Bearer ".concat(token)
            ...
            case 10:
              ...
              if (!content.error) {
                ...
                handleUpdateBusinessList && handleUpdateBusinessList(businessState === null || businessState === void 0 ? void 0 : (_businessState$busine5 = businessState.business) === null || _businessState$busine5 === void 0 ? void 0 : _businessState$busine5.id, {
                  favorite: false
                });
                setBusinessState(_objectSpread(_objectSpread({}, businessState), {}, {
                  business: _objectSpread(_objectSpread({}, businessState === null || businessState === void 0 ? void 0 : businessState.business), {}, {
                ...
                if (favoriteIds) {
                  updateIds = favoriteIds.filter(function (item) {
                    var _businessState$busine6;

                    return item !== (businessState === null || businessState === void 0 ? void 0 : (_businessState$busine6 = businessState.business) === null || _businessState$busine6 === void 0 ? void 0 : _businessState$busine6.id);
                  });
                  setFavoriteIds(updateIds);
                }

                showToast(_ToastContext.ToastType.Success, t('FAVORITE_REMOVED', 'Favorite removed'));
              } else {
                setActionState(_objectSpread(_objectSpread({}, actionState), {}, {
                  loading: false,
                  error: content.result
