...
var BusinessController = function BusinessController(props) {
  ...
  (0, _react.useEffect)(function () {
    if (!isDisabledInterval) {
      var _businessState$busine, _businessState$busine2, _businessState$busine3, _businessState$busine7;
      ...
      console.log("businessId: ".concat((_businessState$busine7 = businessState.business) === null || _businessState$busine7 === void 0 ? void 0 : _businessState$busine7.id, " - lapse:  "), lapse, currentDate);
  ...
  (0, _react.useEffect)(function () {
    ...
    if (business && (business === null || business === void 0 ? void 0 : business.id) !== (businessState === null || businessState === void 0 ? void 0 : (_businessState$busine8 = businessState.business) === null || _businessState$busine8 === void 0 ? void 0 : _businessState$busine8.id)) {
      setBusinessState(_objectSpread(_objectSpread({}, businessState), {}, {
        business: business
      }));
    } else if (!business) {
