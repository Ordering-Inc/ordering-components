...
var CouponControl = function CouponControl(props) {
  var onChangeCouponValue = props.onChangeCouponValue,
  ...
  var handleButtonApplyClick = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {
      var _data$result, response, data;

      return _regenerator.default.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              setcoupon(_objectSpread(_objectSpread({}, coupon), {}, {
                loading: true,
                error: false
              }));
              _context.prev = 1;
              _context.next = 4;
              return fetch("https://apiv4.ordering.co/v400/en/demo/business/41/offers/".concat(couponInput, "?business_id=").concat(businessId));
            ...
            case 7:
              ...
              if (data === null || data === void 0 ? void 0 : (_data$result = data.result) === null || _data$result === void 0 ? void 0 : _data$result.name) {
...
CouponControl.propTypes = {
   ...
   */
  onChangeCouponValue: _propTypes.default.func,
