  ...
  */
  ...
  var getBusiness = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
      var _orderState$options, _cartState$cart2, parameters, _yield$ordering$busin, _yield$ordering$busin2, result, error, _result$paymethods, _paymethodSelected$pa, _paymethodSelected, _paymethodSelected$pa2, _paymethodSelected$pa3, _paymethodSelected$pa4, _t;
  ...
  var handlerClickPlaceOrder = /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(paymentOptions, payloadProps, confirmPayment, dismissPlatformPay) {
      ...
      return _regenerator().w(function (_context2) {
        while (1) switch (_context2.n) {
          ...
          case 9:
            _yield$confirmPayment = _context2.v;
  ...
  var handleChangeSpot = /*#__PURE__*/function () {
    var _ref4 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3(_ref3) {
      var _ref3$isCheckout, isCheckout, bodyToSend, id, endpointToFetch, _yield$endpointToFetc, _yield$endpointToFetc2, error, result, _cart$business, _t2;
      return _regenerator().w(function (_context3) {
        while (1) switch (_context3.p = _context3.n) {
          ...
          case 2:
            _yield$endpointToFetc = _context3.v;
  ...
  var handleChangeComment = function handleChangeComment(value) {
    try {
      if (previousComment !== value) {
        ...
        timeout = setTimeout(/*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee5() {
  ...
  var getDeliveryOptions = /*#__PURE__*/function () {
    var _ref7 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee6() {
      var response, _yield$response$json2, result, error, _t3;
      return _regenerator().w(function (_context6) {
        while (1) switch (_context6.p = _context6.n) {
          ...
          case 1:
            ...
            return response.json();
          case 2:
            _yield$response$json2 = _context6.v;
  ...
  var handleChangeDeliveryOption = /*#__PURE__*/function () {
    var _ref8 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee7(value) {
      var response, _yield$response$json3, result, error, _t4;
      return _regenerator().w(function (_context7) {
        while (1) switch (_context7.p = _context7.n) {
          ...
          case 1:
            ...
            return response.json();
          case 2:
            _yield$response$json3 = _context7.v;
  ...
  var getLoyaltyPlans = /*#__PURE__*/function () {
    var _ref9 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee8() {
      var req, _yield$req$json, error, result, _t5;
  ...
  var handleConfirmCredomaticPage = /*#__PURE__*/function () {
    var _ref0 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee9(cart, paymethodSelected) {
      var _configs$credomatic_i, _configs$credomatic_i2, _configs$credomatic_i3, _configs$credomatic_i4;
      var isSandbox, keyId, processorId, _cart$paymethod_data, _cart$paymethod_data2, _paymethodSelected$da2, _paymethodSelected$da3, _paymethodSelected$da4, _Object$keys, cartUuid, data, form, requestOptions, _t6;
  ...
  (0, _react.useEffect)(function () {
    ...
    var handleAlseaCheckPrice = /*#__PURE__*/function () {
      var _ref10 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee1() {
        var customerFromLocalStorage, apiCheckprice, response, result, _t8;
        return _regenerator().w(function (_context1) {
          while (1) switch (_context1.p = _context1.n) {
            ...
            case 6:
              _context1.p = 6;
              _t8 = _context1.v;
              setAlseaCheckpriceError(_t8 === null || _t8 === void 0 ? void 0 : _t8.message);
              setIsLoadingCheckprice(false);
            case 7:
...
Checkout.defaultProps = {
  ...
  beforeElements: [],
  afterElements: [],
  propsToFetch: ['id', 'name', 'email', 'cellphone', 'address', 'address_notes', 'paymethods', 'logo', 'location', 'configs', 'schedule', 'today']
};