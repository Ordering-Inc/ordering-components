...
var OrderList = function OrderList(props) {
  ...
  (0, _react.useEffect)(function () {
    var _session$user2, _session$user3, _socket$socket, _socket$socket$_callb, _socket$socket$_callb2, _socket$socket2, _socket$socket2$_call, _socket$socket2$_call2;
    ...
    if (socket !== null && socket !== void 0 && (_socket$socket = socket.socket) !== null && _socket$socket !== void 0 && (_socket$socket$_callb = _socket$socket._callbacks) !== null && _socket$socket$_callb !== void 0 && (_socket$socket$_callb2 = _socket$socket$_callb.$orders_register) !== null && _socket$socket$_callb2 !== void 0 && _socket$socket$_callb2.find(function (func) {
