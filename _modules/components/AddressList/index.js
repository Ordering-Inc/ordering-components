...
var AddressList = function AddressList(props) {
  ...
  var userId = props.userId || user.id;
  ...
  var handleSetDefault = /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee2(address) {
      var _yield$ordering$users2, content;
  ...
  var handleDelete = /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee3(address) {
      var _yield$ordering$users3, content, addresses;
      ...
      return _regenerator.default.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 6:
              _yield$ordering$users3 = _context3.sent;
              content = _yield$ordering$users3.content;
              setActionStatus({
                loading: false,
                error: content.error ? content.result : null
              });
