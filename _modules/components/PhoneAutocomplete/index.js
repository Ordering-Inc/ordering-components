...
var PhoneAutocomplete = function PhoneAutocomplete(props) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            cellphoneString = cellphone === null || cellphone === void 0 ? void 0 : (_cellphone$toString = cellphone.toString) === null || _cellphone$toString === void 0 ? void 0 : _cellphone$toString.call(cellphone);
            cellphoneSplited = (cellphoneString === null || cellphoneString === void 0 ? void 0 : (_cellphoneString$matc = cellphoneString.match) === null || _cellphoneString$matc === void 0 ? void 0 : _cellphoneString$matc.call(cellphoneString, /.{1,7}/)) || [];
            retryAttempt = 1;
          case 6:
  ...
  var setGuestOptions = /*#__PURE__*/function () {
    ...
    return function setGuestOptions(_x3) {
  ...
  (0, _react.useEffect)(function () {
    ...
    if (urlPhone) return;
    if (phone && phone.length >= 7 && ((customersPhones === null || customersPhones === void 0 ? void 0 : (_customersPhones$user = customersPhones.users) === null || _customersPhones$user === void 0 ? void 0 : _customersPhones$user.length) === 0 || phone.length === 7) && !customersPhones.loading) {
      getUsers();
    }
  ...
  (0, _react.useEffect)(function () {
    if (!window.localStorage.getItem('local_phone_code')) {
      ...
      var countriesElevenPhone = countriesElevenPhoneLength.find(function (val) {
        var _configs$default_coun, _configs$default_coun2, _configs$default_coun3;
        return val === (configs === null || configs === void 0 ? void 0 : (_configs$default_coun = configs.default_country_code) === null || _configs$default_coun === void 0 ? void 0 : (_configs$default_coun2 = _configs$default_coun.value) === null || _configs$default_coun2 === void 0 ? void 0 : (_configs$default_coun3 = _configs$default_coun2.toUpperCase) === null || _configs$default_coun3 === void 0 ? void 0 : _configs$default_coun3.call(_configs$default_coun2));
      });
    ...
    if (userCustomer !== null && userCustomer !== void 0 && userCustomer.id && orderState !== null && orderState !== void 0 && (_orderState$options2 = orderState.options) !== null && _orderState$options2 !== void 0 && _orderState$options2.user_id && (userCustomer === null || userCustomer === void 0 ? void 0 : userCustomer.id) !== (orderState === null || orderState === void 0 ? void 0 : (_orderState$options3 = orderState.options) === null || _orderState$options3 === void 0 ? void 0 : _orderState$options3.user_id)) {
      ...
      setUserCustomerOptions({
        options: {
          ...
          type: orderState === null || orderState === void 0 ? void 0 : (_orderState$options4 = orderState.options) === null || _orderState$options4 === void 0 ? void 0 : _orderState$options4.type
        },
        customer: userCustomer
      });
    }
  }, [userCustomer === null || userCustomer === void 0 ? void 0 : userCustomer.id, orderState === null || orderState === void 0 ? void 0 : (_orderState$options5 = orderState.options) === null || _orderState$options5 === void 0 ? void 0 : _orderState$options5.user_id]);
