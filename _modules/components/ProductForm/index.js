...
var ProductForm = function ProductForm(props) {
    ...
    if (state !== null && state !== void 0 && state.selected) {
      preselectedOptions.map(function (option, i) {
        if (option !== null && option !== void 0 && option.with_half_option) {
          var _newPizzaState4, _preselectedSuboption, _states$i, _states$i2;
  ...
  */
  ...
  (0, _react.useEffect)(function () {
    ...
    if (!(product !== null && product !== void 0 && product.loading) && product !== null && product !== void 0 && product.product && ((_product$product10 = product.product) === null || _product$product10 === void 0 ? void 0 : (_product$product10$ex = _product$product10.extras) === null || _product$product10$ex === void 0 ? void 0 : _product$product10$ex.length) > 0) {
      ...
      preselectedOptions.map(function (option, i) {
        ...
        suboptionsArray = [].concat(_toConsumableArray(suboptionsArray), [defaultSuboption]);
        if (option !== null && option !== void 0 && option.with_half_option) {
          var _newPizzaState8, _preselectedSuboption2, _states$i3, _states$i4;
