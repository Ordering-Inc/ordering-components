...
var BusinessAndProductList = exports.BusinessAndProductList = function BusinessAndProductList(props) {
  ...
  var getLazyProducts = /*#__PURE__*/function () {
    var _ref6 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(_ref5) {
      ...
      var page, _ref5$pageSize, pageSize, parameters, _orderState$options4, moment, where, searchConditions, source, promises, functionFetch, productEndpoint, _where3, _t, _t2;
      ...
      return _regenerator().w(function (_context3) {
        while (1) switch (_context3.p = _context3.n) {
          ...
          case 6:
            _context3.p = 6;
            _t3 = _context3.v;
            if ((_t3 === null || _t3 === void 0 || (_err$constructor = _t3.constructor) === null || _err$constructor === void 0 ? void 0 : _err$constructor.name) !== 'Cancel') {
              setErrors([(_err$message = _t3 === null || _t3 === void 0 ? void 0 : _t3.message) !== null && _err$message !== void 0 ? _err$message : 'ERROR']);
              setCategoryState(_objectSpread(_objectSpread({}, curCategoryState), {}, {
                loading: false
              }));
            }
      ...
      return _regenerator().w(function (_context4) {
        while (1) switch (_context4.p = _context4.n) {
          ...
          case 4:
            _context4.p = 4;
            _t4 = _context4.v;
            if ((_t4 === null || _t4 === void 0 || (_err$constructor2 = _t4.constructor) === null || _err$constructor2 === void 0 ? void 0 : _err$constructor2.name) !== 'Cancel') {
              setErrors([(_err$message2 = _t4 === null || _t4 === void 0 ? void 0 : _t4.message) !== null && _err$message2 !== void 0 ? _err$message2 : 'ERROR']);
              setCategoryState(_objectSpread(_objectSpread({}, curCategoryState), {}, {
                loading: false
              }));
            }
  ...
  var getProduct = /*#__PURE__*/function () {
    var _ref10 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee5() {
      ...
      var _orderState$options5, _orderState$options6, _orderState$options7, _orderState$options8, _props$product4, _props$product5, _props$product6, source, parameters, _orderState$options9, moment, _yield$ordering$busin, result, product, _t5;
      ...
      return _regenerator().w(function (_context9) {
        while (1) switch (_context9.p = _context9.n) {
          ...
          case 3:
            _context9.p = 3;
            _t9 = _context9.v;
            showToast(_ToastContext.ToastType.Error, _t9.message);
          case 4:
