...
var PageBanner = function PageBanner(props) {
  var _configs$unaddressed_, _orderState$options, _orderState$options8, _orderState$options8$, _orderState$options9, _orderState$options10;
  ...
  var handleGetPageBanner = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var _orderState$options5, _orderState$options6, requestOptions, fetchEndpoint, _configs$location_def, _configs$location_def2, _orderState$options2, _orderState$options2$, _orderState$options3, _orderState$options3$, _orderState$options4, defaultLatitude, defaultLongitude, isInvalidDefaultLocation, defaultLocation, location, type, _orderState$options7, moment, response, _yield$response$json, error, result, totalItems;
