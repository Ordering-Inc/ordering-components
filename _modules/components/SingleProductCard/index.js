...
var SingleProductCard = function SingleProductCard(props) {
  ...
  var addFavoriteProduct = /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 2:
              ...
              _context.next = 9;
              return fetch("".concat(ordering.root, "/users/").concat(user === null || user === void 0 ? void 0 : user.id, "/favorite_products"), requestOptions);
    ...
    return function addFavoriteProduct() {
  ...
  var deleteFavoriteProduct = /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 2:
              ...
              _context2.next = 7;
              return fetch("".concat(ordering.root, "/users/").concat(user.id, "/favorite_products/").concat(product === null || product === void 0 ? void 0 : product.id), {
                method: 'DELETE',
                headers: {
                  'Content-Type': 'application/json',
                  Authorization: "Bearer ".concat(token)
    ...
    return function deleteFavoriteProduct() {
