...
var PaymentOptionStripeLink = exports.PaymentOptionStripeLink = function PaymentOptionStripeLink(props) {
  ...
  var handleSendStripeLink = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(type, callback) {
      var customProviders, data, response, _yield$response$json, result, error, _t;
