...
var MyOrdersList = exports.MyOrdersList = function MyOrdersList(props) {
  ...
  var getOrders = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
      var source, _yield$ordering$setAc, result, _t;
...
MyOrdersList.propTypes = {
   ...
   */
  orderType: _propTypes.default.oneOf(['active', 'previous']).isRequired,
  /**
   * array that must be containt order status
   */
  status: _propTypes.default.arrayOf(_propTypes.default.number).isRequired,
  /**
   * This must be contain array of orders
   */
  orders: _propTypes.default.arrayOf(_propTypes.default.object),
  /**
