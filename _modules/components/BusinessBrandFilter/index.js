...
exports.BusinessBrandFilter = void 0;
...
var BusinessBrandFilter = function BusinessBrandFilter(props) {
  var brands = props.brands,
      isEnabledList = props.isEnabledList,
          ...
          switch (_context.prev = _context.next) {
            ...
            case 8:
              ...
              if (!content.error) {
                setBrandList(_objectSpread(_objectSpread({}, brandList), {}, {
                  loading: false,
                  brands: !isEnabledList ? content === null || content === void 0 ? void 0 : content.result : content === null || content === void 0 ? void 0 : content.result.filter(function (brand) {
...
exports.BusinessBrandFilter = BusinessBrandFilter;
BusinessBrandFilter.propTypes = {
   ...
   */
  isEnabledList: _propTypes.default.bool,

  /**
   * Array of brand
   */
  brands: _propTypes.default.arrayOf(_propTypes.default.object),
