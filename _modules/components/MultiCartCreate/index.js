...
var MultiCartCreate = function MultiCartCreate(props) {
  ...
  var filtValidation = function filtValidation(cart) {
    return (cart === null || cart === void 0 ? void 0 : cart.status) !== 2 && (cart === null || cart === void 0 ? void 0 : cart.valid);
  };

  var cartsUuidForGroup = Object.values(orderState === null || orderState === void 0 ? void 0 : orderState.carts).filter(function (cart) {
  ...
  var createMultiCart = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var response, _yield$response$json, result, error, _result$group;
            ...
            case 6:
              ...
              if (!error) {
                events.emit('go_to_page', {
                  page: 'multi_checkout',
                  params: {
                    cartUuid: result === null || result === void 0 ? void 0 : (_result$group = result.group) === null || _result$group === void 0 ? void 0 : _result$group.uuid
                  }
                });
              }
  ...
  (0, _react.useEffect)(function () {
    if ((cartsUuidForGroup === null || cartsUuidForGroup === void 0 ? void 0 : cartsUuidForGroup.length) > 1) {
      createMultiCart();
    } else if ((cartsUuidForGroup === null || cartsUuidForGroup === void 0 ? void 0 : cartsUuidForGroup.length) === 1) {
      events.emit('go_to_page', {
        page: 'checkout',
        params: {
