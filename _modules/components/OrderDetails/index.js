...
var OrderDetails = function OrderDetails(props) {
  var _props$order, _props$order2, _props$order2$driver, _orderState$order, _orderState$order$dri, _orderState$order13, _orderState$order14, _orderState$order15, _orderState$order20, _orderState$order21, _orderState$order22;
  ...
  */
  ...
  (0, _react.useEffect)(function () {
    var _orderState$order18, _socket$socket, _socket$socket$_callb, _socket$socket$_callb2;
    ...
    var handleTrackingDriver = function handleTrackingDriver(_ref13) {
      ...
      setOrderState(_objectSpread(_objectSpread({}, orderState), {}, {
        order: _objectSpread(_objectSpread({}, orderState.order), {}, {
          driver: _objectSpread(_objectSpread({}, (_orderState$order17 = orderState.order) === null || _orderState$order17 === void 0 ? void 0 : _orderState$order17.driver), {}, {
    ...
    if (socket !== null && socket !== void 0 && (_socket$socket = socket.socket) !== null && _socket$socket !== void 0 && (_socket$socket$_callb = _socket$socket._callbacks) !== null && _socket$socket$_callb !== void 0 && (_socket$socket$_callb2 = _socket$socket$_callb.$update_order) !== null && _socket$socket$_callb2 !== void 0 && _socket$socket$_callb2.find(function (func) {
