...
var OrderDetails = function OrderDetails(props) {
  var _props$order, _props$order2, _props$order2$driver, _orderState$order, _orderState$order$dri, _orderState$order13, _orderState$order14, _orderState$order15, _orderState$order21, _orderState$order22, _orderState$order23;
      ...
      return _regeneratorRuntime().wrap(function _callee6$(_context6) {
        while (1) switch (_context6.prev = _context6.next) {
          case 0:
            ...
            _context6.next = 5;
            return ordering.setAccessToken(token).orders((_orderState$order$id2 = orderState === null || orderState === void 0 ? void 0 : (_orderState$order8 = orderState.order) === null || _orderState$order8 === void 0 ? void 0 : _orderState$order8.id) !== null && _orderState$order$id2 !== void 0 ? _orderState$order$id2 : orderId).save(bodyToSend);
          case 5:
      ...
      return _regeneratorRuntime().wrap(function _callee8$(_context8) {
        while (1) switch (_context8.prev = _context8.next) {
          ...
          case 9:
            ...
            events.emit('order_message_read', (_orderState$order10 = orderState.order) === null || _orderState$order10 === void 0 ? void 0 : _orderState$order10.id);
            _context8.next = 18;
            break;
          case 15:
            _context8.prev = 15;
  ...
  */
        ...
        while (1) switch (_context11.prev = _context11.next) {
          ...
          case 7:
            ...
            if (!(content !== null && content !== void 0 && content.error)) {
              handleReorder(orderState === null || orderState === void 0 ? void 0 : (_orderState$order11 = orderState.order) === null || _orderState$order11 === void 0 ? void 0 : _orderState$order11.id);
              setCartState({
                loading: false,
                error: null
              });
  ...
  var getRoom = function getRoom(roomType) {
    ...
    return !token ? {
      ...
      role: 'public',
      user_id: hashKey
    } : roomType === 'orders' ? (user === null || user === void 0 ? void 0 : user.level) === 0 ? 'orders' : "orders_".concat(userCustomerId || (user === null || user === void 0 ? void 0 : user.id)) : "drivers_".concat((_orderState$order12 = orderState.order) === null || _orderState$order12 === void 0 ? void 0 : _orderState$order12.driver_id);
  };
  (0, _react.useEffect)(function () {
    !orderState.loading && loadMessages();
  }, [orderState === null || orderState === void 0 ? void 0 : (_orderState$order13 = orderState.order) === null || _orderState$order13 === void 0 ? void 0 : _orderState$order13.id, orderState === null || orderState === void 0 ? void 0 : (_orderState$order14 = orderState.order) === null || _orderState$order14 === void 0 ? void 0 : _orderState$order14.status, orderState.loading]);
  (0, _react.useEffect)(function () {
  ...
  }, [props.order, (_orderState$order15 = orderState.order) === null || _orderState$order15 === void 0 ? void 0 : _orderState$order15.id]);
  (0, _react.useEffect)(function () {
  ...
  (0, _react.useEffect)(function () {
    var _orderState$order19, _socket$socket, _socket$socket$_callb, _socket$socket2, _socket$socket2$_call, _socket$socket2$_call2;
    ...
    var handleUpdateOrderDetails = function handleUpdateOrderDetails(order) {
      ...
      if ((order === null || order === void 0 ? void 0 : order.id) !== ((_orderState$order16 = orderState.order) === null || _orderState$order16 === void 0 ? void 0 : _orderState$order16.id)) return;
    ...
    var handleTrackingDriver = function handleTrackingDriver(props) {
      var _orderState$order17, _orderState$order18;
      var location = props.location;
      var driverId = props.driver_id;
      if (driverId !== (orderState === null || orderState === void 0 ? void 0 : (_orderState$order17 = orderState.order) === null || _orderState$order17 === void 0 ? void 0 : _orderState$order17.driver_id)) return;
      ...
      setOrderState(_objectSpread(_objectSpread({}, orderState), {}, {
        order: _objectSpread(_objectSpread({}, orderState.order), {}, {
          driver: _objectSpread(_objectSpread({}, (_orderState$order18 = orderState.order) === null || _orderState$order18 === void 0 ? void 0 : _orderState$order18.driver), {}, {
    ...
    if ((_orderState$order19 = orderState.order) !== null && _orderState$order19 !== void 0 && _orderState$order19.driver_id) {
      socket.join(getRoom('drivers'));
    }
    socket.socket.on('connect', function () {
      var _orderState$order20;
      if (!isDisabledOrdersRoom) socket.join(getRoom('orders'));
      if ((_orderState$order20 = orderState.order) !== null && _orderState$order20 !== void 0 && _orderState$order20.driver_id) {
        socket.join(getRoom('drivers'));
      }
    });
    socket.on('tracking_driver', handleTrackingDriver);
    if (!(socket !== null && socket !== void 0 && (_socket$socket = socket.socket) !== null && _socket$socket !== void 0 && (_socket$socket$_callb = _socket$socket._callbacks) !== null && _socket$socket$_callb !== void 0 && _socket$socket$_callb.$update_order) || socket !== null && socket !== void 0 && (_socket$socket2 = socket.socket) !== null && _socket$socket2 !== void 0 && (_socket$socket2$_call = _socket$socket2._callbacks) !== null && _socket$socket2$_call !== void 0 && (_socket$socket2$_call2 = _socket$socket2$_call.$update_order) !== null && _socket$socket2$_call2 !== void 0 && _socket$socket2$_call2.find(function (func) {
  ...
  }, [messages, socket, (_orderState$order23 = orderState.order) === null || _orderState$order23 === void 0 ? void 0 : _orderState$order23.status, userCustomerId]);
  (0, _react.useEffect)(function () {
