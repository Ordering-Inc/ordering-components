...
var GiftCardsList = exports.GiftCardsList = function GiftCardsList(props) {
  ...
  var getGiftCards = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(page, pageSize) {
      var where, conditions, searchConditions, requestOptions, fetchEndpoint, response, _yield$response$json, error, result, pagination, _t;
