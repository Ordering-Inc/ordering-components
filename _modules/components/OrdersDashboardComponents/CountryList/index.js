...
var CountryList = exports.CountryList = function CountryList(props) {
  ...
  var getBusinessList = /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2() {
      var _yield$ordering$busin, _yield$ordering$busin2, error, result, _businessIds, _t;
      return _regenerator().w(function (_context2) {
        while (1) switch (_context2.p = _context2.n) {
          ...
          case 2:
            ...
            if (!error) {
              _businessIds = result.map(function (business) {
                return business.id;
              });
              handleChangeFilterList(_objectSpread(_objectSpread({}, filterList), {}, {
  ...
  var getCountries = /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3() {
      var where, conditions, searchConditions, isSpecialCharacter, fetchEndpoint, _yield$fetchEndpoint$, _yield$fetchEndpoint$2, error, result, _t2;
      return _regenerator().w(function (_context3) {
        while (1) switch (_context3.p = _context3.n) {
          case 0:
            ...
            fetchEndpoint = where ? ordering.countries().where(where) : ordering.countries();
            _context3.n = 1;
