...
var MapView = exports.MapView = function MapView(props) {
  ...
  var _useState = (0, _react.useState)({
    ...
    assingnedOrders = _useState2[0],
    setAssignedOrders = _useState2[1];
  ...
  var getBusinessLocations = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
      var options, _yield$ordering$setAc, _yield$ordering$setAc2, result, error, _t;
      return _regenerator().w(function (_context) {
        while (1) switch (_context.p = _context.n) {
          case 0:
            _context.p = 0;
            setAssignedOrders(function (prevState) {
