...
var WebsocketProvider = function WebsocketProvider(_ref) {
  ...
  (0, _react.useEffect)(function () {
    ...
    if (configs.url && configs.project) {
      if (session.auth) {
        var _socket = new _socket3.Socket(_objectSpread(_objectSpread({}, configs), {}, {
    ...
    if (socket !== null && socket !== void 0 && socket.socket) {
      socket.socket.on('disconnect', function (reason) {
        if (reason === 'io server disconnect' && session.auth) {
          var _socket$socket;
          setTimeout(socket === null || socket === void 0 ? void 0 : (_socket$socket = socket.socket) === null || _socket$socket === void 0 ? void 0 : _socket$socket.connect(), 1000);
        }
      });
...
var useWebsocket = function useWebsocket() {
  ...
  return sockerManager || new _socket3.Socket({});
};
