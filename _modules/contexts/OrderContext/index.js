...
var OrderProvider = function OrderProvider(_ref) {
  ...
  var isAlseaProject = ordering.project === 'alsea';
  var orderTypes = {
    delivery: 1,
    pickup: 2,
    eatin: 3,
        ...
        while (1) {
          switch (_context22.prev = _context22.next) {
            ...
            case 8:
              ...
              _context22.prev = 9;
              _context22.next = 12;
              return fetch("https://alsea-plugins".concat(isAlseaProject ? '' : '-staging-development', ".ordering.co/alseaplatform/placeorder_error_log.php"), {
                method: 'POST',
                body: JSON.stringify({
                  ...
                  mac_address: Object.keys(deviceInfo).length > 0 ? deviceInfo === null || deviceInfo === void 0 ? void 0 : deviceInfo.ip : '0000'
                }),
                headers: {
                  'Content-Type': 'application/json'
                }
