...
var OrderProvider = function OrderProvider(_ref) {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 13:
              ...
              userId = ((_customerState$user2 = customerState.user) === null || _customerState$user2 === void 0 ? void 0 : _customerState$user2.id) || session.user.id;
              _context.next = 21;
  ...
  var updateOrderOptions = /*#__PURE__*/function () {
    var _ref6 = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee5(changes) {
      var _customerState$user3, body, _yield$ordering$setAc5, _yield$ordering$setAc6, error, result, carts, options, _err$message2, message;
          ...
          switch (_context5.prev = _context5.next) {
            case 0:
              ...
              body = _objectSpread(_objectSpread({}, changes), {}, {
                user_id: ((_customerState$user3 = customerState.user) === null || _customerState$user3 === void 0 ? void 0 : _customerState$user3.id) || session.user.id
              });
              _context5.prev = 2;
              setState(_objectSpread(_objectSpread({}, state), {}, {
                loading: true
  ...
  var addProduct = /*#__PURE__*/function () {
    var _ref7 = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee6(product) {
      var _customerState$user4, body, _yield$ordering$setAc7, _yield$ordering$setAc8, error, result;
        ...
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              ...
              body = {
                product: product,
                user_id: ((_customerState$user4 = customerState.user) === null || _customerState$user4 === void 0 ? void 0 : _customerState$user4.id) || session.user.id
              };
              _context6.next = 5;
  ...
  var removeProduct = /*#__PURE__*/function () {
    var _ref8 = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee7(product) {
      var _customerState$user5, body, _yield$ordering$setAc9, _yield$ordering$setAc10, error, result;
          ...
          switch (_context7.prev = _context7.next) {
            case 0:
              ...
              body = {
                ...
                user_id: ((_customerState$user5 = customerState.user) === null || _customerState$user5 === void 0 ? void 0 : _customerState$user5.id) || session.user.id
              };
              _context7.next = 5;
  ...
  var clearCart = /*#__PURE__*/function () {
    var _ref9 = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee8(uuid) {
      var _customerState$user6, body, response, _yield$response$json, error, result;
        ...
        while (1) {
          switch (_context8.prev = _context8.next) {
            case 0:
              ...
              body = JSON.stringify({
                uuid: uuid,
                user_id: ((_customerState$user6 = customerState.user) === null || _customerState$user6 === void 0 ? void 0 : _customerState$user6.id) || session.user.id
              });
              _context8.next = 5;
  ...
  var updateProduct = /*#__PURE__*/function () {
    var _ref10 = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee9(product) {
      var _customerState$user7, body, _yield$ordering$setAc11, _yield$ordering$setAc12, error, result;
        ...
        while (1) {
          switch (_context9.prev = _context9.next) {
            case 0:
              ...
              body = {
                product: product,
                user_id: ((_customerState$user7 = customerState.user) === null || _customerState$user7 === void 0 ? void 0 : _customerState$user7.id) || session.user.id
              };
              _context9.next = 5;
  ...
  var applyCoupon = /*#__PURE__*/function () {
    var _ref11 = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee10(couponData) {
      ...
      var _customerState$user8, body, _yield$ordering$setAc13, _yield$ordering$setAc14, error, result;
          ...
          switch (_context10.prev = _context10.next) {
            ...
            case 6:
              ...
              body = {
                ...
                user_id: ((_customerState$user8 = customerState.user) === null || _customerState$user8 === void 0 ? void 0 : _customerState$user8.id) || session.user.id
              };
              _context10.next = 11;
  ...
  var changeDriverTip = /*#__PURE__*/function () {
    var _ref12 = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee11(businessId, driverTipRate) {
      ...
      var _customerState$user9, body, _yield$ordering$setAc15, _yield$ordering$setAc16, error, result;
          ...
          switch (_context11.prev = _context11.next) {
            ...
            case 6:
              ...
              body = {
                ...
                user_id: ((_customerState$user9 = customerState.user) === null || _customerState$user9 === void 0 ? void 0 : _customerState$user9.id) || session.user.id
              };
              _context11.next = 11;
  ...
  var placeCart = /*#__PURE__*/function () {
    var _ref13 = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee12(cardId, data) {
      var _customerState$user10, body, _yield$ordering$setAc17, _yield$ordering$setAc18, error, result, orderObject;
          ...
          switch (_context12.prev = _context12.next) {
            case 0:
              ...
              body = _objectSpread(_objectSpread({}, data), {}, {
                user_id: ((_customerState$user10 = customerState.user) === null || _customerState$user10 === void 0 ? void 0 : _customerState$user10.id) || session.user.id
              });
              _context12.next = 5;
  ...
  var confirmCart = /*#__PURE__*/function () {
    var _ref14 = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee13(cardId, data) {
      var _customerState$user11, body, _yield$ordering$setAc19, _yield$ordering$setAc20, error, result, cart;
        ...
        while (1) {
          switch (_context13.prev = _context13.next) {
            case 0:
              ...
              body = _objectSpread(_objectSpread({}, data), {}, {
                user_id: ((_customerState$user11 = customerState.user) === null || _customerState$user11 === void 0 ? void 0 : _customerState$user11.id) || session.user.id
              });
              _context13.next = 5;
  ...
  var reorder = /*#__PURE__*/function () {
    var _ref15 = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee14(orderId) {
      var _customerState$user12, _yield$ordering$setAc21, _yield$ordering$setAc22, error, result;
          ...
          switch (_context14.prev = _context14.next) {
            case 0:
              ...
              return ordering.setAccessToken(session.token).orders(orderId).reorder({
                ...
                query: {
                  user_id: ((_customerState$user12 = customerState.user) === null || _customerState$user12 === void 0 ? void 0 : _customerState$user12.id) || session.user.id
                }
              });
