...
var NativeStrategy = exports.NativeStrategy = /*#__PURE__*/function () {
  function NativeStrategy() {
    _classCallCheck(this, NativeStrategy);
  }
  return _createClass(NativeStrategy, [{
    key: "getItem",
    value: function () {
      var _getItem = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(storageKey, isJson) {
        var value;
    ...
    key: "setItem",
    value: function () {
      var _setItem = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(key, val) {
        var isJson,
          value,
          _args2 = arguments;
